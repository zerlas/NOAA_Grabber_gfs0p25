...
fetch()
{
    ...
    do
        ...
        do
            ...
            #wget "http://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25.pl?file=gfs.t${gfs_hour}z.pgrb2.0p25.f${after_hour}&lev_${levels[$i]}=on&var_${vars[$i]}=on&leftlon=0&rightlon=360&toplat=90&bottomlat=-90&dir=%2Fgfs.${gfs_date}${gfs_hour}" -O $file_name -a $SAVE_DIR/log
